...
const DirectMessagesButton: React.FC = () => (
  <IconButton
...
const FindPeopleButton: React.FC = () => (
  <IconButton
...
const ActivityFeedButton: React.FC = () => (
  <IconButton
...
export const ProfileButton: React.FC = () => (
  <IconButton aria-label="Activity feed" icon={<Avatar name="C O" size="xs" />} variant="nav" />
)
